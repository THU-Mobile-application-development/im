...
public class ChatProcessor {
    ...
    public ChatRelation getChatRelation(String my_username, String to_username) {
        Query query = new Query();
        query.addCriteria(Criteria.where(KeyConstant.MY_USERNAME).is(my_username)
    ...
    public void createChatRelation(String my_username, String to_username, Notification noty, List<ChatProps> chat_list) {
        Date time = new Date();
        ChatRelation relation = new ChatRelation();
        relation.setMyUsername(my_username);
    ...
    public void updateChatNotification(String my_username, String to_username, Notification noty) {
        Query query = new Query();
        query.addCriteria(Criteria.where(KeyConstant.MY_USERNAME).is(my_username)
                .and(KeyConstant.TO_USERNAME).is(to_username));
    ...
    public void updateChat(String my_username, String to_username, ChatProps chat) {
        Query query = new Query();
        query.addCriteria(Criteria.where(KeyConstant.MY_USERNAME).is(my_username)
                .and(KeyConstant.TO_USERNAME).is(to_username));
...
//    }
    ...
    public void deleteChat(String my_username,String to_username, Date send_time) {
            Query query = new Query();
            query.addCriteria(Criteria.where(KeyConstant.MY_USERNAME).is(my_username)
                    .and(KeyConstant.TO_USERNAME).is(to_username)
